...
namespace noochAdminNew.Classes.PushNotification
{
    public static class ApplePushNotification
    {
        public static string SendNotificationMessage(string alertText, int badge, string sound, string devicetokens, string username, string password)
        {
            ...
            Utility.Utility.GameThriveResponseClass gamethriveresponse = JsonConvert.DeserializeObject<Utility.Utility.GameThriveResponseClass>(response);
